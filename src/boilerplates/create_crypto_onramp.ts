...
const CRYPTO_ONRAMP_REPO_URL = "https://github.com/0xsequence-demos/crypto-onramp-boilerplate";
...
export async function createCryptoOnramp(program: Command, options: any) {
    ...
    shell.exec(`git clone ${CRYPTO_ONRAMP_REPO_URL} ${REPOSITORY_FILENAME}`, { silent: !options.verbose });
    ...
    cliConsole.info(`To learn how to work with on-ramp, please visit the following link: ${SEQUENCE_DOCS_URL + SEQUENCE_DOC_PATH}`);
