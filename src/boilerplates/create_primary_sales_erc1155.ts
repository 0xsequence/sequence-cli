...
const PRIMARY_SALES_ERC1155_REPO_URL =
  'https://github.com/0xsequence-demos/primary-sale-1155-boilerplate';
...
export async function createPrimarySalesErc1155(
  program: Command,
  options: any
) {
  ...
  shell.exec(
    `git clone ${PRIMARY_SALES_ERC1155_REPO_URL} ${REPOSITORY_FILENAME}`,
  ...
  cliConsole.done(
    `Great! Now you can test the project with your WaaS. If you want to take it to the next level by using your own Primary Sales Contracts in the project, go to the following link and we can set it up: ${SEQUENCE_DOCS_URL}guides/primary-sales`
  );
