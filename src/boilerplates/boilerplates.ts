...
export function makeCommandBoilerplates(program: Command) {
  ...
  comm
    ...
    .description(
      'Clone a starter boilerplate for Google widget authenticated Sequence Embedded Wallet integrated with React'
    )
    .option('--waas-config-key <waas_key>', 'WaaS config key for this project')
    .option(
      '--project-access-key <access_key>',
  ...
  comm
    ...
    .description(
      'Create a server that has the ability to mint collectibles based on parameters'
    )
    .option(
      '-k, --key <private_key>',
  ...
  comm
    ...
    .description(
      'Clone a starter boilerplate for email authenticated Sequence Embedded Wallet integrated with React'
    )
    .option('--waas-config-key <waas_key>', 'WaaS config key for this project')
    .option(
      '--project-access-key <access_key>',
  ...
  comm
    ...
    .description(
      'Clone a starter boilerplate for Stytch authenticated Sequence Embedded Wallet integrated with React'
    )
    .option('--waas-config-key <waas_key>', 'WaaS config key for this project')
    .option(
      '--project-access-key <access_key>',
  ...
  comm
    ...
    .description(
      'Clone a starter boilerplate for Sequence Embedded wallet linking demo integrated with React'
    )
    .option('--waas-config-key <waas_key>', 'WaaS config key for this project')
    .option(
      '--project-access-key <access_key>',
  ...
  comm
    ...
    .description(
      'Clone a starter boilerplate for Sequence Embedded Wallet verification from a server-side application'
    )
    .option('--waas-config-key <waas_key>', 'WaaS config key for this project')
    .option(
      '--project-access-key <access_key>',
  ...
  comm
    ...
    .description(
      'Clone a starter boilerplate for Primary Sales integrated with WaaS'
    )
    .option('--waas-config-key <waas_key>', 'WaaS config key for this project')
    .option(
      '--project-access-key <access_key>',
  ...
  comm
    ...
    .description(
      'Clone a starter boilerplate for Crypto Onramp integrated with Embedded Wallet, using React'
    )
    .option('--waas-config-key <waas_key>', 'WaaS config key for this project')
    .option(
      '--project-access-key <access_key>',
