...
const SequenceMarktetplace_V1_ABI = [
    {
...
async function approvalERC1155(client, input) {
    ...
    const isApprovedForAll = await collectionContract.read.isApprovedForAll([input.walletAddress, SEQUENCE_MARKETPLACE_V1_ADDRESS], {
        account: client.account,
    });
    if (!isApprovedForAll) {
        await collectionContract.write.setApprovalForAll([SEQUENCE_MARKETPLACE_V1_ADDRESS, true], {
            account: client.account,
            chain: client.chain,
        });
...
async function approvalERC721(client, input) {
    ...
    if (!isApprovedForAll) {
        await collectionContract.write.setApprovalForAll([SEQUENCE_MARKETPLACE_V1_ADDRESS, true], { account: client.account, chain: client.chain });
